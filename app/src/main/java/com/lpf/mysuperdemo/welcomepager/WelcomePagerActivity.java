package com.lpf.mysuperdemo.welcomepager;
...
import com.lpf.mysuperdemo.welcomepager.adapter.SCViewPagerAdapter;
import com.lpf.mysuperdemo.welcomepager.util.SCViewAnimationUtil;
import com.lpf.mysuperdemo.welcomepager.views.DotsView;
import com.lpf.mysuperdemo.welcomepager.views.SCPositionAnimation;
import com.lpf.mysuperdemo.welcomepager.views.SCViewAnimation;
import com.lpf.mysuperdemo.welcomepager.views.SCViewPager;


/**
 * Created by liupf5 on 2015/10/22.
 */
public class WelcomePagerActivity extends FragmentActivity {
    ...
    private void initViews() {
        mViewPager = (SCViewPager)findViewById(R.id.wl_viewpager);
        mDotsView = (DotsView)findViewById(R.id.wl_dotsview);
        mDotsView.setDotResource(R.drawable.dot_selected,R.drawable.dot_unselected);
        mDotsView.setNumberOfPage(NUM_PAGES);

        mPageAdapter = new SCViewPagerAdapter(getSupportFragmentManager());
        mPageAdapter.setNumberOfPage(NUM_PAGES);
        mPageAdapter.setFragmentBackgroundColor(android.R.color.holo_orange_dark);
    ...
    private void initAnimations(){
        final Point size = SCViewAnimationUtil.getDispalySize(this);
        ...
        atSkexAnimation.addPageAnimation(new SCPositionAnimation(this,0,0,-(size.y - atSkex.getHeight())));
        atSkexAnimation.addPageAnimation(new SCPositionAnimation(this, 1, -size.x, 0));
        ...
        commonlyAnimation.startToPosition(size.x, null);//先向右进行了偏移
